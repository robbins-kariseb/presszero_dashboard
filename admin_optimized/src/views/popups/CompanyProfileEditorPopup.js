...
function CompanyProfileEditorPopup({ item, popupType, handleClose }) {
    ...
    const [autoReplyMessage, setAutoReplyMessage] = React.useState(item.autoReplyMessage || `Thank you for contacting ${item.businessName}. \nOur office is currently closed.\nWe appreciate your inquiry and will respond to your message as soon as possible once we return on the next business day.\nFor urgent matters, please contact us during our regular business hours.\nThank you for your understanding.\nBest regards,\nThe ${item.businessName} Team`)
                    ...
                    <div className='col-2x2 flex'>
                        {popupType === "edit" &&
                            <div id="editor-form" className='form-classic col-1x2 editor-form'>
                                ...
                                <TextEditor value={renderText(autoReplyMessage)} onChange={setAutoReplyMessage} />
                            </div>}
                        {popupType === "edit" &&
