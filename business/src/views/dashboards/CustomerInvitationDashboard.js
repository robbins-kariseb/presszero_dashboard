    ...
    return (
        <React.Fragment>
            ...
            <PageContainer 
                ...
                searchSpace={data}
                addons={
                    <div className='col-1x3 tab-wrapper stack-control'>
                        <div className='col-1x3 tab-wrapper time-series-tabs float-right'>
                        <Button 
                            special={"special"} 
                            title="Invite Users" 
                            onClick={()=>{}} 
                        ...
                        <div className='col-1x3 tab-wrapper time-series-tabs float-right'>
                            <SearchBar placeholder={"Find a customer: just write name or email"} onChange={()=>{}} />
                        </div>
                    </div>
                }
            >
                                ...
                                {activeUserList.map((e,idx)=> <tr>
                                    ...
                                    <td>
                                        <Button 
                                            ...
                                            title={<span style={{color:"red"}} class="material-symbols-outlined">delete</span>}
                                        />
                                    </td>
                                </tr>)}
                            </tbody>
