...
const AppProvider = ({ children }) => {
  ...
  const handleUserSignIn = async ({username, password, accessKey, verification}) => {
    if (verification === undefined) {
      ...
      if (user.response === "successful" && user.userData && (user.userData.accessGroup === "super-user" || user.userData.accessGroup === "admin" || user.userData.accessGroup === "owner" || user.userData.accessGroup === "ghost-user")) {
